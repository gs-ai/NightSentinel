...
from groom_lake.core import base
from groom_lake.core.constants import BANNER_WEB
from groom_lake.core.web.db import Tasks
...
def create_app():
    ...
    from groom_lake.core.web.api import resources

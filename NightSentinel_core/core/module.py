...
import yaml
# framework libs
from groom_lake.core import framework
from groom_lake.utils import validators
...
class BaseModule(framework.Framework):
    ...
    def do_run(self, params):
        ...
        try:
            ...
            self.print_exception()
            self.error('Something broken? See https://github.com/lanmaster53/SR71-ng/wiki/Troubleshooting#issue-reporting.')
        finally:
